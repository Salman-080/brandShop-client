    ...
    return (
        ...
        <div className={`${theme=="lightTheme"? "dark_theme": "light_theme"} mt-14 py-10 space-y-7`}>
            <div className="text-center space-y-3">
                <h2 className="text-4xl font-semibold text-orange-500">Have A question?</h2>
                <p className=" text-sm text-orange-300 font-medium">Feel free to reach out to us with any inquiries you may have; we're here to assist you around the clock!</p>
            </div>
            <div className="mx-auto  flex justify-center ">
                <form className="bg-gray-300 px-6 py-10 w-[400px] md:w-[650px] space-y-3 ">
                    ...
                    <div className="flex justify-center"><button className="btn bg-orange-500 border border-green-500 text-white"> Submit</button></div>
                </form>
            </div>
