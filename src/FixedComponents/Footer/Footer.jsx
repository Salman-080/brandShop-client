...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-gray-800 text-neutral-content flex flex-col justify-center">
            <div className="flex justify-center items-center mx-auto">
                <img className="w-[40px] h-[40px] rounded-full" src="/BrandBites.png" alt="" />
                <h2 className="text-xl">BrandBites</h2>
            </div>
            <div className="flex gap-6 mx-auto">
                ...
                <div className="flex gap-6 font-normal text-sm mx-auto">
                    <h2>Home</h2>
                    <h2>About Us</h2>
                    <h2>Our Team</h2>
                    <h2>Contact Us</h2>
